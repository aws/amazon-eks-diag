...
Function Write-Log {
    <#
    .SYNOPSIS
    Custom loggin method for writing to stdout as well as the global log file
    ...
    .PARAMETER IsError
    A switch indicating that the message should be handled as a non-terminating error
    #>
    [CmdletBinding()]
    Param (
        [Parameter(
